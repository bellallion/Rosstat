"""
Модели данных для проекта «Статистика России».

Определяют структуру хранения статистических данных:
- численность населения
- занятость и безработица
- занятость по видам экономической деятельности
- рабочие места
- занятость выпускников (ВО и СПО)
- трудоустройство по специальностям (ВО и СПО)
"""
